...
import static org.torpedoquery.jakarta.jpa.Torpedo.extend;
import static org.torpedoquery.jakarta.jpa.Torpedo.from;
import static org.torpedoquery.jakarta.jpa.Torpedo.innerJoin;
import static org.torpedoquery.jakarta.jpa.Torpedo.leftJoin;
import static org.torpedoquery.jakarta.jpa.Torpedo.rightJoin;
import static org.torpedoquery.jakarta.jpa.Torpedo.select;
import static org.torpedoquery.jakarta.jpa.Torpedo.where;
import static org.torpedoquery.jakarta.jpa.Torpedo.with;
import static org.torpedoquery.jakarta.jpa.TorpedoFunction.count;
...
import org.torpedoquery.jakarta.jpa.test.bo.ExtendEntity;
import org.torpedoquery.jakarta.jpa.test.bo.SubEntity;
...
public class TorpedoTest
{
	...
	public void test_createQuery()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Entity> select = select(entity);
	...
	public void test_createFreezeQuery()
	{
		final Entity entity = from(Entity.class);
		org.torpedoquery.jakarta.jpa.Query<Entity> select = select(entity);
		org.torpedoquery.jakarta.jpa.Query<String> select2 = select(entity.getName());
		assertEquals("select entity_0 from Entity entity_0", select.getQuery());
	...
	public void test_createFreezeQueryWithFunction()
	{
		final Entity entity = from(Entity.class);
		org.torpedoquery.jakarta.jpa.Query<Entity> select = select(entity);
		org.torpedoquery.jakarta.jpa.Query<Long> select2 = select(count(entity));
		assertEquals("select entity_0 from Entity entity_0", select.getQuery());
	...
	public void test_createFreezeQueryWithJoin()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Entity> select = select(entity);
		org.torpedoquery.jakarta.jpa.Query<String> select2 = select(subEntity.getName());
	...
	public void test_createFeeezeWithCountFunction()
	{
		final Entity entity = from(Entity.class);
		where(entity.getPrimitiveInt()).eq(10);
		org.torpedoquery.jakarta.jpa.Query<Long> select = select(count(entity));
	...
	{
		final Entity entity = from(Entity.class);
		org.torpedoquery.jakarta.jpa.Query<String> select = select(entity.getCode());
	...
	public void test_selectMultipleFields()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Object[]> select = select(entity.getCode(), entity.getName());
	...
	public void test_selectMultipleFieldsFromDifferentEntities()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Object[]> select = select(entity.getCode(), subEntity.getCode());
		assertEquals(
	...
	public void test_select_multipleFields_keepsOrder()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Object[]> select = select(subEntity.getCode(), entity.getCode());
		assertEquals(
	...
	public void test_innerJoin_withSelect()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Object[]> select = select(entity.getCode(), subEntity.getName());
	...
	public void test_condition_only_on_join()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Entity> select = select(from);
		assertEquals(
	...
	public void test_Join_Select_Come_Before_The_Root()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<Object[]> select = select(innerJoin.getName(), from.getCode());
	...
	public void testJoinWith_with_Condition()
	{
		...
		org.torpedoquery.jakarta.jpa.Query<SubEntity> select = select(innerJoin);
		String query = select.getQuery();
		Map<String, Object> parameters = select.getParameters();
		assertEquals(
	...
	{
		Entity from = from(Entity.class);
		org.torpedoquery.jakarta.jpa.Query<String> select = select(from.getSubEntity().getCode());
